...
-- AddForeignKey
ALTER TABLE "check-ins" ADD CONSTRAINT "check-ins_attendee_id_fkey" FOREIGN KEY ("attendee_id") REFERENCES "attendees"("public_id") ON DELETE CASCADE ON UPDATE CASCADE;
